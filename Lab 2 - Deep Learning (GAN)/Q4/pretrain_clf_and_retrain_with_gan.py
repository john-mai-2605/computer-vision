...
clf.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
clf.load_weights('save_weight_classifier/normal/540_100.0_0.h5')
...
new_path_save_model = 'save_weight_classifier/pretrain_then_fake/' + str(100*perc_real) + '_' + str(100*perc_fake) + '.h5'
