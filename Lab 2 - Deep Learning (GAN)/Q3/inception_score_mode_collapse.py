...
# Build the generator
generator = generator()
generator.load_weights("../Q2/saved_model_weights/version3/generator_weights_19000.h5")

# the classifier
path_save_model = 'save_weight_classifier/version_1.h5'
model = tf.keras.models.load_model(path_save_model)

# this function used to calculate inception score, the input p_yx is a list of condition probabilities
...
# this function generate images and then compute the inception score for these images
