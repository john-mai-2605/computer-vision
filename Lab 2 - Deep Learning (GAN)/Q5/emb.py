...
path_save_model = '../Q3/save_weight_classifier/version_1.h5'
...
plt.scatter(x = emb_tsne[:100,0], y=emb_tsne[:100,1], c=y_test, marker = "o", label = "Real")
plt.scatter(x = emb_tsne[100:,0], y=emb_tsne[100:,1], c=y_gen, marker = "x", label = "Fake")
plt.legend(loc=4)
